...
The  code will call the checkPrime method with one or more integer arguments.
We should write the checkPrime method in such a way that the code prints only the prime numbers.
